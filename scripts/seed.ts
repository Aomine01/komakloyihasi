...
async function seed() {
  ...
  const statsData = [
    { key: 'total_funded', value: '541', labelUz: 'Moliyalashtirilgan loyihalar', icon: 'briefcase' },
    ...
    { key: 'total_loan_uzs', value: '69.156', labelUz: "Ajratilgan ssuda (mlrd so'm)", icon: 'banknote' },
  ];
