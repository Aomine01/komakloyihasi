    ...
    <>
      ...
      <section className="py-24 px-6 bg-surface-container-low" id="about">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <motion.h2 custom={0} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={fadeUp} className="font-headline text-3xl lg:text-4xl font-bold text-on-surface">
            Loyiha haqida
          </motion.h2>
          ...
          <div className="grid sm:grid-cols-3 gap-8 pt-12">
            <motion.div custom={2} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={fadeUp} className="bg-surface-container-lowest p-8 rounded-xl shadow-ambient text-left border border-outline-variant/15">
            ...
            <motion.div custom={3} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={fadeUp} className="bg-surface-container-lowest p-8 rounded-xl shadow-ambient text-left border border-outline-variant/15">
            ...
            <motion.div custom={4} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={fadeUp} className="bg-surface-container-lowest p-8 rounded-xl shadow-ambient text-left border border-outline-variant/15">
      ...
      <section className="py-24 px-6 bg-surface">
        <div className="max-w-7xl mx-auto">
          <motion.div custom={0} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={fadeUp} className="text-center mb-16">
            <h2 className="font-headline text-3xl lg:text-4xl font-bold text-on-surface">Loyihaning asosiy maqsadlari</h2>
            <p className="mt-4 text-lg text-on-surface-variant">To&apos;rt muhim yo&apos;nalish bo&apos;yicha barqaror rivojlanishni ta&apos;minlash</p>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Card 1 (Large) */}
            <motion.div custom={1} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={fadeUp} className="lg:col-span-2 bg-surface-container-low rounded-2xl p-8 lg:p-12 relative overflow-hidden flex flex-col justify-between min-h-[300px]">
            ...
            {/* Card 2 */}
            <motion.div custom={2} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={fadeUp} className="bg-surface-container-highest rounded-2xl p-8 flex flex-col justify-between border border-outline-variant/15">
              <div>
            ...
            {/* Card 3 */}
            <motion.div custom={3} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={fadeUp} className="bg-surface-container-low rounded-2xl p-8 flex flex-col justify-between border border-outline-variant/15">
              <div>
            ...
            {/* Card 4 (Wide) */}
            <motion.div custom={4} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={fadeUp} className="lg:col-span-2 bg-gradient-to-br from-surface-container to-surface-variant rounded-2xl p-8 lg:p-12 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div custom={0} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={fadeUp}>
              <h2 className="font-headline text-3xl lg:text-4xl font-bold text-on-surface mb-6">Imtiyozli Ssuda shartlari</h2>
            ...
            <motion.div custom={2} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={fadeUp} className="bg-surface-container-lowest p-8 rounded-2xl shadow-ambient border border-outline-variant/15 relative overflow-hidden">
