    ...
    <section className="pt-32 pb-24 lg:pt-48 lg:pb-32 px-6 relative overflow-hidden bg-surface">
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center relative z-10 pt-8 lg:pt-16">
        <div className="space-y-8 flex flex-col items-center">
          ...
          <motion.h1 custom={1} initial="hidden" animate="visible" variants={fadeUp} className="font-headline text-5xl md:text-6xl lg:text-[5rem] font-black leading-[1.1] text-on-surface tracking-tight">
            <span className="text-gradient">Ko‘mak</span> - orzularga <br className="hidden md:block" /> qanot beramiz!
          </motion.h1>

          <motion.p custom={2} initial="hidden" animate="visible" variants={fadeUp} className="text-xl md:text-2xl text-on-surface-variant leading-relaxed font-body max-w-3xl text-center">
          ...
          <motion.div custom={3} initial="hidden" animate="visible" variants={fadeUp} className="flex flex-col sm:flex-row gap-5 pt-6 w-full sm:w-auto justify-center">
            <a
              ...
              className="inline-flex justify-center items-center gap-2 bg-gradient-primary text-on-primary px-8 py-4 rounded-xl font-bold hover:opacity-90 transition-all text-lg shadow-lg hover:shadow-xl w-full sm:w-auto hover:-translate-y-0.5 duration-200"
            >
              Loyihaga qo&apos;shilish
            ...
            <a
              href="#about"
              className="inline-flex justify-center items-center gap-2 bg-surface-container-high text-primary px-8 py-4 rounded-xl font-bold hover:bg-surface-container-highest transition-all text-lg w-full sm:w-auto border border-outline-variant/30 hover:-translate-y-0.5 duration-200"
            >
              Batafsil ma&apos;lumot
            </a>
          </motion.div>
